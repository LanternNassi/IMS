...
namespace Abbey_Trading_Store.UI.Advanced.CustomMessageBox
{
    public partial class FormMessageBox : Form
    {
        ...
        private void SetFormSize()
        {
            ...
            int height = this.panelTitleBar.Height + this.labelMessage.Height + this.button1.Height + 40 + this.panelBody.Padding.Top;
            this.Size = new Size(widht, height);
        }
        private void SetButtons(MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            int xCenter = (this.panelBody.Width / 2) - (this.button1.Width/2) + 10;
            int yCenter = this.button1.Location.Y;
            switch (buttons)
            {
