...
namespace Abbey_Trading_Store.UI
{
    public partial class Transaction_Details : Form
    {
        ...
        private void Transaction_Details_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = TD.GetAllTransactionDetails(lbltop.Text , frmTransactions.transaction_id);
            ...
            //}
            print = TD.GetAllTransactionDetails(lbltop.Text , frmTransactions.transaction_id);
            filter = dt;
